...
<div class="min-h-screen text-white p-4 sm:p-6 md:p-8 relative pb-[200px] sm:pb-[160px] md:pb-[120px]">
    ...
    <div class="text-center mb-12">
        <div class="flex justify-center mb-4">
            <div class="inline-flex items-center px-4 py-2 bg-[#D06E31] bg-opacity-20 ">
                <svg class="w-5 h-5 mr-2 text-[#D06E31]" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M17.707 9.293a1 1 0 010 1.414l-7 7a1 1 0 01-1.414 0l-7-7A.997.997 0 012 10V5a3 3 0 013-3h5c.256 0 .512.098.707.293l7 7zM5 6a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd" />
                </svg>
                <span class="text-[#D06E31] font-medium">Тег</span>
            </div>
        </div>
        ...
        <p class="text-base sm:text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed" style="font-family: Inter, 'Helvetica Neue', Helvetica, sans-serif;">
            ...
            echo 'Найдено <strong>' . $post_count . '</strong> ' . _n('статья', 'статьи', $post_count) . ' с тегом "<strong class="text-[#D06E31]">' . single_tag_title('', false) . '</strong>"';
            ?>
        </p>
    </div>
            ...
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                <article class="bg-[#222223] shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:scale-105  overflow-hidden" onclick="window.location.href='<?php echo esc_url(get_permalink()); ?>'">
                    ...
                    <div class="p-6">
                        ...
                        $other_tags = array_filter($post_tags, function($tag) {
                            return $tag->name !== single_tag_title('', false);
                        });
                        if ($other_tags) : 
                        ?>
                            <div class="flex flex-wrap gap-2">
                                <?php foreach (array_slice($other_tags, 0, 3) as $tag) : ?>
            ...
            <?php else : ?>
                <div class="text-center py-12 col-span-full">
                    <div class="mb-6">
                        ...
                        <h3 class="text-xl font-semibold text-gray-400 mb-2">Статьи с этим тегом не найдены</h3>
                        <p class="text-gray-500">Пока нет публикаций с тегом "<?php single_tag_title(); ?>"</p>
                    </div>
                    <div class="space-x-4">
